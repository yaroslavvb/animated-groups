...
the convention with Conway et al.'s fibrifold notation.  Here “cyclic” refers
to the permutation image generated by all symmetries, not to every individual
generator being the same full cycle: inverses, identity elements, and powers
with several disjoint cycles are all elements of a cyclic image.
