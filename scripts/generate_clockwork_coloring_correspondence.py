  ...
  <main class="correspondence-page">
    ...
    <section class="book-method" aria-labelledby="book-method-title">
      ...
      <p>
        ...
        that the full quotient is cyclic. Each printed-page link opens an expanded, highlighted
        excerpt with at least five times the original focus area; complete pages and the source PDF are not
